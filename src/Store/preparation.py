5                                                                                                                                                                                                                                 6656§µ„55  import numpy as np
import pandas as pd
...
def check_dataframe(input_dataframe):
    #print (input_dataframe.describe())
    fila_con_nan = input_dataframe.isnull()['CultureID']
    filas_con_nan = input_dataframe[fila_con_nan]
    print(filas_con_nan)
    #input_dataframe['CultureID'].hist()


check_dataframe(read_product())